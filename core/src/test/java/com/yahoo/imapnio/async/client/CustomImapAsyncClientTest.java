...
import com.yahoo.imapnio.async.client.CustomImapAsyncClient.ImapClientChannelInitializer;
...
/**
 * Unit test for {@link CustomImapAsyncClient}.
 */
public class CustomImapAsyncClientTest {
    ...
    public void testCreateSessionNoLocalAddressNoSNISuccessful() throws SSLException, URISyntaxException, Exception {
        ...
        final CustomImapAsyncClient aclient = new CustomImapAsyncClient(clock, bootstrap, group, logger);
        ...
        final CustomImapAsyncClient customClient = new CustomImapAsyncClient(100);
