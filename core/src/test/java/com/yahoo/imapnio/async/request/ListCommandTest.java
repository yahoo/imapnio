...
public class ListCommandTest {
    ...
    public void setUp() {
        ...
        final Class<?> classUnderTest = ListCommand.class;
    ...
    public void testGetCommandLine() throws ImapAsyncClientException, IllegalArgumentException, IllegalAccessException {
        ...
        Assert.assertEquals(cmd.getCommandLine(), "LIST \"\" \"*test*\"\r\n", "Expected result mismatched.");
    ...
    public void testGetCommandLineReferenceExists()
        ...
        final ImapRequest cmd = new ListCommand("~smith/Mail/", "foo.*");
        Assert.assertEquals(cmd.getCommandLine(), "LIST ~smith/Mail/ \"foo.*\"\r\n", "Expected result mismatched.");
    ...
    public void testGetCommandType() {
        final ImapRequest cmd = new ListCommand("", "*test*");
        Assert.assertSame(cmd.getCommandType(), ImapRFCSupportedCommandType.LIST);
    }
}