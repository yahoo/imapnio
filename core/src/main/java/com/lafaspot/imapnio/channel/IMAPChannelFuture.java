...
public class IMAPChannelFuture {	
     ...
     * is done.  If this future is already
     * completed, the specified listener is notified immediately.
     * @param  listener the future listener
     * @return the channel future object
     */
    public IMAPChannelFuture addListener(IMAPChannelFutureListener listener) {
    	this.futureListener = listener;
    	IMAPChannelFuture theFuture = this;
