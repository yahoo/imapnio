...
public class UidExpungeCommand  extends ImapRequestAdapter {
     ...
     * Initializes a @{code UidExpungeCommand} with the message sequence syntax.
     *
     * @param uids the string representing message sequence or UID based on RFC3501
     */
    ...
    public String getCommandLine() {
        final StringBuilder sb = new StringBuilder(UID_EXPUNGE).append(ImapClientConstants.SPACE)
                .append(uids).append(ImapClientConstants.CRLF);
