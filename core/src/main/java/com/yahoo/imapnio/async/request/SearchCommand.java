...
public class SearchCommand extends ImapRequestAdapter {
     ...
     * @throws SearchException when SearchSequence.generateSequence() encounters error
     */
    private SearchCommand(@Nonnull final String msgSeqs, @Nullable final SearchTerm term) throws SearchException, IOException {
     ...
     * @throws SearchException when SearchSequence.generateSequence() encounters error
     */
    public SearchCommand(@Nonnull final MessageNumberSet[] msgsets, @Nullable final SearchTerm term) throws SearchException, IOException {
