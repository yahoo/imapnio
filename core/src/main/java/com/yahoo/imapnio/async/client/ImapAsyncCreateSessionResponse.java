...
/**
 * This class is the response for the @{code ImapAsyncClient} createSession method response.
 */
public class ImapAsyncCreateSessionResponse {
    /** An instance of ImapAsyncSession object created through createSession method in @{code ImapAsyncClient}. */
    ...
    /**
     * Instantiates a @{code ImapAsyncCreateSessionResponse} instance with ImapAsyncSession object and server initial greeting. Based on RFC3501,
     * server initial greeting is an un-tagged response.
     * 
     * @param session ImapAsyncSession instance that is created by createSession method in @{code ImapAsyncClient}
