...
public class UidSearchCommand extends ImapRequestAdapter {
    ...
    /**
     * Initializes a @{code UidSearchCommand} with the string form of message sequence, search string and character set name.
     *
     * @param msgSeqs the messages sequence string
     * @param searchString the search string
     * @param charset the character set
     */
    public UidSearchCommand(@Nonnull final String msgSeqs, @Nullable final String searchString, @Nullable final String charset) {
